namespace QL_KhachSan
{
    ...
    public partial class KhachSanContext : DbContext
    {
        ...
        {
            // Dùng CreateDatabaseIfNotExists để chỉ tạo database nếu chưa tồn tại
            // Dữ liệu cũ sẽ được giữ lại, chỉ seed data mẫu khi database mới được tạo
            Database.SetInitializer<KhachSanContext>(new CreateDB());
            
            // Đảm bảo database được tạo ngay khi khởi tạo context
            ...
            {
                // Nếu database đã tồn tại, ignore exception
            }
        }
